/*
  ...
  - You are about to alter the column `timeStamp` on the `Playerdata` table. The data in that column could be lost. The data in that column will be cast from `BigInt` to `Int`.
